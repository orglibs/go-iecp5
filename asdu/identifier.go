...
// <136..255> Special App
// NOTE: Information objects with or without time scales are distinguished by different sequences of identifier types.
const (
	...
	// System commands in the monitoring direction <70..99>
...
// seq: bit7
// 0: Collection of information elements of the same type with different objAddresses (address + element)*N
// 1： A collection of information elements of the same type and in the same objAddress order (one address, N elements * N).
...
// <48..63> Specialised scope
// NOTE: Information objects with or without a timescale are distinguished by different sequences of identifier types.
const (
