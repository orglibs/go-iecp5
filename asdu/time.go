...
// ParseCP24Time2a 3 octets of binary time, UTC recommended for all timescales, reads 3 bytes, returns a time.
// See companion standard 101, subclass 7.2.6.19.
...
// CP16Time2a msec to CP16Time2a 2 octet binary time.
// See companion standard 101, subclass 7.2.6.20.
func CP16Time2a(msec uint16) []byte {
	return []byte{byte(msec), byte(msec >> 8)}
}

// ParseCP16Time2a 2 octets of binary time, reads 2 bytes, returns a value.
// See companion standard 101, subclass 7.2.6.20.
